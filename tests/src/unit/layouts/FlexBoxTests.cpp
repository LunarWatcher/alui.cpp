...
TEST_CASE("Verify nested sizing logic", "[alui::FlexBox][Layout]") {
    ...
    auto fb = std::make_shared<alui::FlexBox>(
        ...
        alui::ComponentConfig {
            ...
            .id = 0,
            .padding{10},
            .minHeight = alui::Magnitude {300.0f},
    ...
    auto inner = std::make_shared<alui::FlexBox>(
        ...
        alui::ComponentConfig {
            ...
            .id = 1,
            .padding{10},
            .minHeight = alui::Magnitude {230.f},
            .style = test::getDebugStyleSpec(),
        }
    );
    ...
    auto text = std::make_shared<alui::Text>(
        ...
        alui::ComponentConfig {
            ...
            .id = 2,
            .padding{10},
            .minWidth = alui::Magnitude::Absolute(500.0f),
            .minHeight = alui::Magnitude {200.f},
            .style = test::getDebugStyleSpec(),
        }
    );
...
TEST_CASE("Layout wrapping, single horizontal layout", "[alui::FlexBox][Layout]") {
    ...
    auto text2 = std::make_shared<alui::Text>("x3 Hewwo x3 aaaaaaaaaaaaaaaaaaaaaaaaaaaaa", alui::ComponentConfig {
        .flex{1},
        .padding = 15.0f,
        .maxWidth = alui::Magnitude::Absolute(340.f),
        .style = test::getDebugStyleSpec(),
    });
    //text->setDimensions(50, 100);
